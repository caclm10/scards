...
const AlertDialogOverlay = React.forwardRef(
     ...
     * @param {React.ElementRef<typeof AlertDialogPrimitive.Overlay>} ref
     */
    ({ className, ...props }, ref) => (
...
const AlertDialogContent = React.forwardRef(
     ...
     * @param {React.ElementRef<typeof AlertDialogPrimitive.Content>} ref
     */
    ({ className, ...props }, ref) => (
        <AlertDialogPortal>
            <AlertDialogOverlay />
...
const AlertDialogHeader = ({ className, ...props }) => (
    <div
        className={cn(
            "flex flex-col space-y-2 text-justify",
            className
        )}
        {...props}
    />
...
const AlertDialogTitle = React.forwardRef(
     ...
     * @param {React.ElementRef<typeof AlertDialogPrimitive.Title>} ref
     */
    ({ className, ...props }, ref) => (
...
const AlertDialogDescription = React.forwardRef(
     ...
     * @param {React.ElementRef<typeof AlertDialogPrimitive.Description>} ref
     */
    ({ className, ...props }, ref) => (
...
const AlertDialogAction = React.forwardRef(
    /**
     *
     * @param {React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Action> & {variant?: import("./Button").ButtonVariants["variant"]}} props
     * @param {React.ElementRef<typeof AlertDialogPrimitive.Action>} ref
     */
...
const AlertDialogCancel = React.forwardRef(
     ...
     * @param {React.ElementRef<typeof AlertDialogPrimitive.Cancel>} ref
     */
    ({ className, ...props }, ref) => (
