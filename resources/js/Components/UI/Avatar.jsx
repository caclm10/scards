...
const Avatar = React.forwardRef(
     ...
     * @param {React.ElementRef<typeof AvatarPrimitive.Root>} ref 
     */
    ({ className, ...props }, ref) => (
...
const AvatarImage = React.forwardRef(
     ...
     * @param {React.ElementRef<typeof AvatarPrimitive.Image>} ref 
     */
    ({ className, ...props }, ref) => (
...
const AvatarFallback = React.forwardRef(
     ...
     * @param {React.ElementRef<typeof AvatarPrimitive.Fallback>} ref 
     */
    ({ className, ...props }, ref) => (
